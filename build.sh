...
if $SHOW_VERSION; then
  ...
  exec mono "$CAKE_EXE" $SCRIPT -verbosity=$VERBOSITY -configuration=$CONFIGURATION -target=$TARGET -netcoreonly=$NETCOREONLY $DRYRUN "${SCRIPT_ARGUMENTS[@]}"
fi
